 ...
 * Open a command prompt and execute this command: 
 ```gawk -f brim.awk mygcode.gcode > mynewgcode.gcode```
...
* The extra brim is only added to vertical sides of the existing brim so it won't work if your piece has a triangular or more complex base
